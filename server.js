...
// Get video information endpoint (renamed)
app.get('/api/fetchVideo/info/:videoId', async (req, res, next) => {
  try {
...
// Download video endpoint (renamed)
app.get('/api/fetchVideo/download/:videoId', async (req, res, next) => {
  try {
    const { videoId } = req.params;
